              ...
              data: {
                  ...
                  items: [
                      ...
                      },
                      {
                          ...
                          type: "paragraph",
                          data: {
                              text: 'Workspace in classic editors is made of a single contenteditable element, used to create different HTML markups. Editor.js workspace consists of separate Blocks: paragraphs, headings, images, lists, quotes, etc. Each of them is an independent <sup data-tune="footnotes ">1</sup> contenteditable element (or more complex structure) provided by Plugin and united by Editors Core.',
                          },
                          tunes: {
                              footnotes: [
...
const ReactEditorJS = createReactEditorJS()
  ...
  return (
    <ReactEditorJS defaultValue={blocks} tools={{
      header: Header,
      list: List,
      quote: Quote,
      table: Table,
